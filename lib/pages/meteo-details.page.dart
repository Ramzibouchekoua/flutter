...
class _MeteoDetailsPageState extends State<MeteoDetailsPage> {
  ...
  void initState() {
    super.initState();
    geMeteoData(widget.ville);
  }

  void geMeteoData(String ville) {
    print("Meteo de la ville: " + ville);
    String url =
        "https://api.openweathermap.org/data/2.5/forcast?q=${ville}&appid=c109c07bc4df77a88c923e6407aef864";
